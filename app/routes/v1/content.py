...
@router.post("/{post_id}", response_model=PostContentOut, tags=["Content"], openapi_extra={
    "requestBody": {
        "content": {
            "application/json": {
                "examples": {
...
@router.get("/{post_id}/{content_id}", response_model=PostContentOut, tags=["Content"],
...
@router.delete("/{post_id}/{content_id}", response_model=PostContentOut, tags=["Content"],
...
@router.delete('/{post_id}', response_model=MessageResponse, tags=["Content"],
...
@router.patch("/{post_id}/{content_id}", response_model=PostContentOut, tags=["Content"],
